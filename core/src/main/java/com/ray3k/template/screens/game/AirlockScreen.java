...
import static com.ray3k.template.Resources.SpineAirLock.*;
import static com.ray3k.template.Resources.*;

public class AirlockScreen extends JamScreen {
    public Stage stage;
    ...
    public void show() {
        ...
        typingLabel = new TypingLabel("What!? The door has sealed behind me.", skin);
        playSound(sfx_lineWhatTheDoor);
    ...
    public void act(float delta) {
        ...
        if (bbox != null) {
            ...
            if (isButtonJustPressed(Buttons.LEFT)) {
                switch (bbox.getName()) {
                    case "window":
                        core.transition(new WindowScreen());
                        break;
                    case "door":
                        typingLabel.setText("What!? The door has sealed behind me.");
                        typingLabel.restart();
                        playSound(sfx_lineWhatTheDoor);
                        break;
                }
