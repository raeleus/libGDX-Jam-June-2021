...
import static com.ray3k.template.Resources.SpineStorageLock.*;
import static com.ray3k.template.Resources.*;

public class StorageLockScreen extends JamScreen {
    public Stage stage;
    ...
    public void show() {
        ...
        typingLabel = new TypingLabel("I need something to bust these locks.", skin);
        typingLabel.setWrap(true);
        table.add(typingLabel).growX().expandY().top();
        
        playSound(sfx_lineINeedSomethingTo);
