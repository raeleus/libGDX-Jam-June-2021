...
public class SecretEndingScreen extends JamScreen {
    private Stage stage;
    ...
    public void show() {
        ...
        videoDrawable = new VideoDrawable(Gdx.files.internal("video/secret-ending.webm"));
        videoDrawable.videoPlayer.setOnCompletionListener(
                (FileHandle file) -> Gdx.app.postRunnable(() -> core.transition(new CreditsScreen())));
