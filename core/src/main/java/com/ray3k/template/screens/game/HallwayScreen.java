...
import static com.ray3k.template.Resources.SpineHallway.*;
import static com.ray3k.template.Resources.*;

public class HallwayScreen extends JamScreen {
    public Stage stage;
    ...
    public void show() {
        ...
        typingLabel = new TypingLabel("This ship is nothing but a series interconnected corridors.", skin);
        playSound(sfx_lineTheShipIs);
            ...
            if (isButtonJustPressed(Buttons.LEFT)) {
                switch (bbox.getName()) {
                    case "door":
                        ...
                        break;
                    case "schematic":
                        core.transition(new SchematicScreen());
                        break;
                    case "arrow":
