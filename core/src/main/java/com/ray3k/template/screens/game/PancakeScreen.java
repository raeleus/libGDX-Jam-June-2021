...
import static com.ray3k.template.Resources.SpinePancakes.*;
import static com.ray3k.template.Resources.*;

public class PancakeScreen extends JamScreen {
    public Stage stage;
    ...
    public void show() {
        ...
        typingLabel = new TypingLabel("Thoughtful Pancakes, my favorite.", skin);
        typingLabel.setWrap(true);
        table.add(typingLabel).growX().expandY().top();
        
        playSound(sfx_lineThoughtfulPancakes);
