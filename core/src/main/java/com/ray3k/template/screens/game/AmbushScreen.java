...
public class AmbushScreen extends JamScreen {
    private Stage stage;
    ...
    public void show() {
        ...
        videoDrawable = new VideoDrawable(Gdx.files.internal("video/ambush.webm"));
        videoDrawable.videoPlayer.setOnCompletionListener(
                (FileHandle file) -> Gdx.app.postRunnable(() -> core.transition(new Engineering2Screen())));
