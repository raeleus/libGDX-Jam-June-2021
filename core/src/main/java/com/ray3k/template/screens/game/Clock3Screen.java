...
import static com.ray3k.template.Resources.SpineClock.*;
import static com.ray3k.template.Resources.*;

public class Clock3Screen extends JamScreen {
    public Stage stage;
    ...
    public void show() {
        ...
        animationState.setAnimation(0, animationThree, false);
        animationState.setAnimation(1, animationSeconds, true);
        ...
        typingLabel = new TypingLabel("They say time is relative. It’s hard to keep track being isolated out here in space. ", skin);
        typingLabel.setWrap(true);
        table.add(typingLabel).growX();
        
        playSound(sfx_lineTheySayTime);
