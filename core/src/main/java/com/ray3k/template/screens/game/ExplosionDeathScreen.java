...
public class ExplosionDeathScreen extends JamScreen {
    private Stage stage;
    ...
    public void show() {
        ...
        videoDrawable = new VideoDrawable(Gdx.files.internal("video/explosion-death.webm"));
        videoDrawable.videoPlayer.setOnCompletionListener(
                (FileHandle file) -> Gdx.app.postRunnable(() -> core.transition(new GameOverScreen())));
