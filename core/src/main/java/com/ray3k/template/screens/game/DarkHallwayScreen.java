...
import static com.ray3k.template.Resources.SpineDarkHallway.*;
import static com.ray3k.template.Resources.*;

public class DarkHallwayScreen extends JamScreen {
    public Stage stage;
            ...
            if (isButtonJustPressed(Buttons.LEFT)) {
                switch (bbox.getName()) {
                    case "arrow":
                        ...
                        break;
                    case "exit":
                        if (unlockedMechanicalLock) {
                            core.transition(new LabScreen());
                        } else {
                            core.transition(new MechanicalLockScreen());
                        }
                        break;
                    case "panda":
                        typingLabel.setText("Panda, I never had the chance to tell you. Duty always got in the way of my true feelings. I always loved you. I will avenge you, Panda.");
                        typingLabel.restart();
                        playSound(sfx_linePandaNeverHad);
                        break;
                }
