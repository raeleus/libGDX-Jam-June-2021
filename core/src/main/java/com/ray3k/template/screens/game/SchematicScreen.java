...
import static com.ray3k.template.Resources.SpineSchematic.*;
import static com.ray3k.template.Resources.*;

public class SchematicScreen extends JamScreen {
    public Stage stage;
    ...
    public void show() {
        ...
        typingLabel = new TypingLabel("USS libGDX. Such a strange design for an interstellar ship.", skin);
        typingLabel.setWrap(true);
        table.add(typingLabel).growX().expandY().top();
        
        playSound(sfx_lineUssLibgdx);
