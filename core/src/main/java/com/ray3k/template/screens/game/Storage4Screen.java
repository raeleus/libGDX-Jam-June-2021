...
import static com.ray3k.template.Resources.SpineStorage4.*;
import static com.ray3k.template.Resources.*;

public class Storage4Screen extends JamScreen {
    public Stage stage;
    ...
    public void show() {
        ...
        typingLabel = new TypingLabel("Something big came through here. Whatever it is, it’s long gone.", skin);
        playSound(sfx_lineSomethingCameThrough);
    ...
    public void act(float delta) {
        ...
        if (bbox != null) {
            ...
            if (isButtonJustPressed(Buttons.LEFT)) {
                switch (bbox.getName()) {
                    case "clock":
                        core.transition(new Clock3Screen());
                        break;
                }
