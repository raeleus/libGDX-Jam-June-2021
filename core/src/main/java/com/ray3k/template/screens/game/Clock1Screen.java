...
public class Clock1Screen extends JamScreen {
    public Stage stage;
    ...
    public void show() {
        ...
        animationState.setAnimation(0, animationNine, false);
        ...
        typingLabel = new TypingLabel("Tick tock.", skin);
        typingLabel.setWrap(true);
        table.add(typingLabel).growX();
        
        playSound(sfx_lineTickTock);
