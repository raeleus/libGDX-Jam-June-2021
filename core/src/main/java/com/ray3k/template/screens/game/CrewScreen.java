...
import static com.ray3k.template.Resources.SpineCrew.*;
import static com.ray3k.template.Resources.*;

public class CrewScreen extends JamScreen {
    public Stage stage;
    ...
    public void show() {
        ...
        typingLabel = new TypingLabel("Damn, the killer made his way through here. It looks like some of the crew " +
                "managed to barricade the navigation module and hold up there. The rest of them went for the escape pods.", skin);
        playSound(sfx_lineDamnTheKiller);
    ...
    public void act(float delta) {
        ...
        if (bbox != null) {
            ...
            if (isButtonJustPressed(Buttons.LEFT)) {
                switch (bbox.getName()) {
                    case "escape-pod":
                        typingLabel.setText("Hopefully someone will come back around and pick these guys up or they’ll be floating out there forever. ");
                        typingLabel.restart();
                        playSound(sfx_lineHopefullySomebodyWill);
                        break;
                    case "body":
                        core.transition(new BodyScreen());
                        break;
                    case "graffiti":
                        typingLabel.setText("\"Die libGDX scum.\" Maniac. How did someone like this pass the psych evaluation?");
                        typingLabel.restart();
                        playSound(sfx_lineDieLibgdxScum);
                        break;
                    case "arrow":
