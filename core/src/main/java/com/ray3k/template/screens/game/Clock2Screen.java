...
public class Clock2Screen extends JamScreen {
    public Stage stage;
    ...
    public void show() {
        ...
        animationState.setAnimation(0, animationTwo, false);
        ...
        typingLabel = new TypingLabel("A constant reminder of how short our lives are. Time’s running out.", skin);
        typingLabel.setWrap(true);
        table.add(typingLabel).growX();
        
        playSound(sfx_lineAConstantReminder);
