...
import static com.ray3k.template.Resources.SpineStorage1.*;
import static com.ray3k.template.Resources.*;

public class Storage1Screen extends JamScreen {
    public Stage stage;
    ...
    public void show() {
        ...
        typingLabel = new TypingLabel("Empty. It must be a slow day for business.", skin);
        typingLabel.setWrap(true);
        table.add(typingLabel).growX().expandY().top();
        
        playSound(sfx_lineEmptyMustBe);
